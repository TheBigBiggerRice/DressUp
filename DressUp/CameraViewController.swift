...
final class CameraViewController: DUViewController {
  ...
  fileprivate let nameButton: DUButton = {
    let button = DUButton()
    button.translatesAutoresizingMaskIntoConstraints = false
    button.setTitle("Name this item", for: .normal)
  ...
  fileprivate let saveButton: DUButton = {
    let button = DUButton()
    button.translatesAutoresizingMaskIntoConstraints = false
    button.setTitle("Save to closet", for: .normal)
    button.setTitleColor(.black, for: .normal)
    button.layer.cornerRadius = 25
    button.layer.borderWidth = 1.5
    button.layer.borderColor = UIColor.black.cgColor
  ...
  deinit {
    ...
    nameButton.removeTarget(self, action: nil, for: .allEvents)
  ...
  private func initialize() {
    ...
    overviewScrollView.addSubview(nameButton)
    ...
    nameButton.addTarget(self, action: #selector(CameraViewController.nameButtonTapped), for: .touchUpInside)
    ...
    //name button
    overviewScrollView.addConstraint(NSLayoutConstraint(item: nameButton, attribute: .centerX, relatedBy: .equal, toItem: overviewScrollView, attribute: .centerX, multiplier: 1.0, constant: 0))
    overviewScrollView.addConstraint(NSLayoutConstraint(item: nameButton, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: screenWidth - 20))
    overviewScrollView.addConstraint(NSLayoutConstraint(item: nameButton, attribute: .top, relatedBy: .equal, toItem: colorLabel, attribute: .bottom, multiplier: 1.0, constant: 50))
    overviewScrollView.addConstraint(NSLayoutConstraint(item: nameButton, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 50))
    ...
    overviewScrollView.addConstraint(NSLayoutConstraint(item: saveButton, attribute: .bottom, relatedBy: .equal, toItem: overviewScrollView, attribute: .bottom, multiplier: 1.0, constant: -10))
    overviewScrollView.addConstraint(NSLayoutConstraint(item: saveButton, attribute: .top, relatedBy: .equal, toItem: nameButton, attribute: .bottom, multiplier: 1.0, constant: 10))
    overviewScrollView.addConstraint(NSLayoutConstraint(item: saveButton, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: 50))
  ...
  //name button
  private dynamic func nameButtonTapped() {
    ...
    let alertView = SCLAlertView(appearance: appearance)
    let nameTextField = alertView.addTextField("Name this item")
    nameTextField.delegate = self
    alertView.addButton("Confirm") {
      if nameTextField.text != "" {
        self.nameTag = nameTextField.text!
        self.nameButton.setTitle(nameTextField.text!, for: .normal)
      }
    }
    
    let alertViewIcon = UIImage(named: "name_tag")
    _ = alertView.showCustom("Add Name", subTitle: "Give this item a unique name", color: UIColor.royalBlue, icon: alertViewIcon!)
    
  }
  
  fileprivate func displayNameButton() {
...
extension CameraViewController: UIImagePickerControllerDelegate {
  ...
  func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
    ...
    if let image = info[UIImagePickerControllerOriginalImage] as? UIImage {
      ...
      nameButton.setTitle("Name this item", for: .normal)
      nameTag = ""
